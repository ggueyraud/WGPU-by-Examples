...
use wgpu_book_examples::wgpu_simplified as ws;
use winit::{
    event::*,
...
impl State {
    async fn new(window: &Window, sample_count: u32) -> Self {
        ...
        let shader = init
            .device
            .create_shader_module(wgpu::include_wgsl!("triangle_wgpu_buffer.wgsl"));
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            let msaa_attachment = ws::create_msaa_color_attachment(&view, &self.msaa_texture_view);
...
fn main() {
    ...
    window.set_title(&*format!("{}_{}", "ch01_line_msaa", sample_count));
